package com.glc.slidetoggleview;
...
import com.glc.slidetoggleview.ext.DisplayUtils;
import com.glc.slidetoggleview.shimmer.ShimmerTextView;
...
public class SlideToggleView extends FrameLayout {
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBlockView.setBackground(slideBlock);
